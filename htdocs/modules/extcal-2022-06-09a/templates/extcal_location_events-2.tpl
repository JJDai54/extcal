        ...
        <table class="outer"   width="100%">
            <tr>
                <td>&nbsp;<strong><u><{$smarty.const._MD_EXTCAL_LOCATION_EVENTS_VENIR}></strong></u><br><br>
                    <div style="width: 100%; height: 300px; overflow-y: scroll; background-color:#FFFFFF; scrollbar-arrow-color:blue; scrollbar-face-color: #e7e7e7; scrollbar-3dlight-color: #a0a0a0; scrollbar-darkshadow-color:#888888">
