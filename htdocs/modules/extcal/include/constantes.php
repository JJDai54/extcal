...
//define('_EXTCAL_SHOW_TPL_NAME', $xoopsModuleConfig['displayTemplateName']);


//modif JJD
define('_EXTCAL_MODULE', 'extcal');
define('_EXTCAL_URL', XOOPS_URL . "/modules/" .  _EXTCAL_MODULE );
...
define('_EXTCAL_CLS_SAINT', 'saint');
...
define('_EXTCAL_CLN_SAINT', 'Saint');
...
define('_EXTCAL_FILE_LOCATION_LIST',  _EXTCAL_NAV_LOCATION_LIST . _EXTCAL_SUFFIX_VIEW);
...
define('_EXTCAL_URL_NAV', "year=%s&month=%s&day=%s&cat=%s");
...
function toRGB($Hex){
    ...
    $t = array();
    $t['R'] = hexdec(substr($Hex,0,2));
    $t['G'] = hexdec(substr($Hex,2,2));
    $t['B'] = hexdec(substr($Hex,4,2));
