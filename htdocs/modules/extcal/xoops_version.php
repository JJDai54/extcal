...
$modversion['author']           = 'Zoullou, Mage, Mamba, JJDai (JJ Delalandre)';
$modversion['nickname']         = '';
$modversion['website']          = '';
...
if (isset($GLOBALS['xoopsModule']) && is_object($GLOBALS['xoopsModule'])) {
    ...
    if ($catHandler->haveSubmitRight($user)) {
        $modversion['sub'][$i]['name'] = _MI_EXTCAL_SUBMIT_EVENT;
        $modversion['sub'][$i]['url']  = _EXTCAL_FILE_NEW_EVENT;
    }
...
$modversion['config'][$i]['formtype']    = 'textbox';
$modversion['config'][$i]['valuetype']   = 'text';
$modversion['config'][$i]['default']     = _MI_EXTCAL_IB_DATE_PATTERN_VALUE;
//----------------------------------------------------------------------------------
++$i;
$modversion['config'][$i]['name']        = 'css_extcal';
$modversion['config'][$i]['title']       = '_MI_EXTCAL_CSS_ECTCAL';
$modversion['config'][$i]['description'] = '_MI_EXTCAL_CSS_ECTCAL_DESC';
$modversion['config'][$i]['formtype']    = 'yesno';
$modversion['config'][$i]['valuetype']   = 'int';
$modversion['config'][$i]['default']     = 0;
++$i;
$modversion['config'][$i]['name']        = 'tdb_rgb';
$modversion['config'][$i]['title']       = '_MI_EXTCAL_CALENDAR_TDB';
$modversion['config'][$i]['description'] = '_MI_EXTCAL_CALENDAR_TDB_DESC';
$modversion['config'][$i]['formtype']    = 'color';
$modversion['config'][$i]['valuetype']   = 'text';
$modversion['config'][$i]['default']     = "#DDDDDD";

++$i;
$modversion['config'][$i]['name']        = 'trb_rgb';
$modversion['config'][$i]['title']       = '_MI_EXTCAL_CALENDAR_TRB';
$modversion['config'][$i]['description'] = '_MI_EXTCAL_CALENDAR_TRB_DESC';
$modversion['config'][$i]['formtype']    = 'color';
$modversion['config'][$i]['valuetype']   = 'text';
$modversion['config'][$i]['default']     = "#505000";

++$i;
$modversion['config'][$i]['name']        = 'tdo_rgb';
$modversion['config'][$i]['title']       = '_MI_EXTCAL_CALENDAR_TDO';
$modversion['config'][$i]['description'] = '_MI_EXTCAL_CALENDAR_TDO_DESC';
$modversion['config'][$i]['formtype']    = 'color';
$modversion['config'][$i]['valuetype']   = 'text';
$modversion['config'][$i]['default']     = "#505050";
//----------------------------------------------------------------------------------
++$i;
...
$modversion['config'][$i]['options']     =  $t; //array_flip ($t);
...
//     'title'       => '_MI_EXTCAL_MINICAL_SHOW_SAINT',
//     'description' => '',
//     'formtype'    => 'yesno',
//     'valuetype'   => 'int',
//     'default'     => 0,
...
$modversion['config'][] = [
    ...
    'title'       => '_MI_EXTCAL_SHOW_TPL_NAME',
    'description' => '_MI_EXTCAL_SHOW_TPL_NAME_DESC',
    'formtype'    => 'yesno',
    'valuetype'   => 'int',
    'default'     => 0,
];
...
$modversion['templates'][$i]['description'] = 'Liste des événements';

++$i;
$modversion['templates'][$i]['file']        = 'extcal_view_title.tpl';
$modversion['templates'][$i]['description'] = 'Entete des calendriers mensuels, hbdo,...';
...
++$i;
$modversion['templates'][$i]['file']        = 'extcal_location_list.tpl';
$modversion['templates'][$i]['description'] = 'list of locations';
++$i;
$modversion['templates'][$i]['file']        = 'extcal_location_edit.tpl';
$modversion['templates'][$i]['description'] = 'edit location';
++$i;
$modversion['templates'][$i]['file']        = 'extcal_location_events.tpl';
$modversion['templates'][$i]['description'] = 'Evenemments par location';
...
++$i;
$modversion['templates'][$i]['file']        = 'extcal_view_calendar_style-01.tpl';
$modversion['templates'][$i]['description'] = 'Style et couleur de fond des calendrier';

++$i;
$modversion['templates'][$i]['file']        = 'extcal_search.tpl';
$modversion['templates'][$i]['description'] = 'Bloc de recherche annee/mois/cat';
...
++$i;
$modversion['templates'][$i]['file']        = 'admin/extcal_debug_info.tpl';
$modversion['templates'][$i]['description'] = 'Affiche le nom du template en cours';
//-------------------------------------------------------------
...
$modversion['blocks'][$i]['options']     = '0|0|150|225|1|3|10|0|1|1,2,3,4,5|| |120|120|1';
