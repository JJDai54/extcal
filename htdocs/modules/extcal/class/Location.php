...
class Location extends \XoopsObject
{
    public function __construct()
    {
        ...
        $this->initVar('location_id', XOBJ_DTYPE_INT, null, false, 5);
...
//
//         $form->addElement(new \XoopsFormHidden('location_id',  $this->getVar('location_id')));
//         $form->addElement(new \XoopsFormText(_MD_EXTCAL_LOCATION_NOM, 'nom', 50, 255, $this->getVar('nom')), true);
//         $form->addElement(getEditor(_MD_EXTCAL_DESCRIPTION, 'description', $this->getVar('description'), 5));
...
//         $form->addElement(new \XoopsFormText(_MD_EXTCAL_CP, 'cp', 10, 10, $this->getVar('cp')), false);
