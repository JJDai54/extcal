...
define('_AM_EXTCAL_ERREUR_NO_ETABLISSEMENT', "There is no establishment in the database");
define('_AM_EXTCAL_ETABLISSEMENT', "Establishment");
...
define('_AM_EXTCAL_ETABLISSEMENT_FORM_DELETE', "Delete establishment");
define('_AM_EXTCAL_ETABLISSEMENT_FORM_EDIT', "Modify establishment");
define('_AM_EXTCAL_ETABLISSEMENT_FORM_NOM', "Name");
define('_AM_EXTCAL_ETABLISSEMENT_FORM_TELEPHONE', "Phone");
define('_AM_EXTCAL_ETABLISSEMENT_SURDEL', "Are you sure you want to delete it?");
define('_AM_EXTCAL_ETABLISSEMENTS', "Establishments");
...
define('_AM_EXTCAL_ACTIF', "Active");
define('_AM_EXTCAL_ADD_CATEGORY', "Add category");
define('_AM_EXTCAL_ADRESSE', "Address");
define('_AM_EXTCAL_APPROVE_EVENT', "Approve this event");
...
define('_AM_EXTCAL_CAT_DELETED_NOR_ALLOWED', "Deletion prohibited,<br>delete all events in the category before.");
define('_AM_EXTCAL_CAT_EDITED', "Category edited");
define('_AM_EXTCAL_CITY', "City");
...
define('_AM_EXTCAL_EVENT_APPROVED', "Events approved");
...
define('_AM_EXTCAL_EVENT_SUBMITED', "Events submit");
define('_AM_EXTCAL_EVENT_UPDATED', "The event is updated !");
...
define('_AM_EXTCAL_INACTIVATE_EVENT', "Deactivatre this event");
...
define('_AM_EXTCAL_MOBILE', "Mobile");
define('_AM_EXTCAL_MULTIUPLOADS_NOT_OK', "The multiuploads component is not installed.<br><br><a href='https://xoops.kiolo.fr/modules/mydownloads/'>Download here the multiuploads component</a><br><br>and install it in the folder 'class/xoopsform/'");
...
define('_AM_EXTCAL_PUBLIC_PERM_MASK_INFO_DESC', "This allows you to define a default permission mask that will be applied to all new categories created.<br><font color='red'>Be careful because these permissions will be automatically applied to all new categories.</font>");
define('_AM_EXTCAL_RECURRENT', "Recurrent");
define('_AM_EXTCAL_REDIRECT_DELOK', "successfully deleted");
define('_AM_EXTCAL_SEARCH', "Search");
...
define('_AM_EXTCAL_SUBMITER', "Submitter");
define('_AM_EXTCAL_TELEPHONE', "Phone");
