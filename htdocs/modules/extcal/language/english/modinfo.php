...
define('_MI_EXTCAL_CALENDAR_TDB_DESC', 'TEnir compte d\'un taux d\'opacity de 0.4, les cellule survollée seront avec un taux de 1');

define('_MI_EXTCAL_CALENDAR_TRB', 'Couleur de fonds des lignes au survol de la souris');
define('_MI_EXTCAL_CALENDAR_TRB_DESCc', '');
