...
CREATE TABLE `extcal_saint` (
  `saint_id` int(11)  NOT NULL AUTO_INCREMENT,
  `saint_month` int(11) NOT NULL,
  `saint_day` int(11) NOT NULL,
  `saint_category` varchar(50) NOT NULL,
  `saint_name` varchar(50) NOT NULL,
